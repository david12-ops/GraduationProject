...
export type Teams = {
  __typename?: 'Teams';
  countOfDraw?: Maybe<Scalars['Int']>;
  countOfGoalsThatScoredOponnent?: Maybe<Scalars['Int']>;
  countOfLose?: Maybe<Scalars['Int']>;
  countOfPoints?: Maybe<Scalars['Int']>;
  countOfScoredGoals?: Maybe<Scalars['Int']>;
  countOfWins?: Maybe<Scalars['Int']>;
  country: Scalars['String'];
...
export type TeamQuery = {
  ...
  teams: Array<{
    ...
    country: string;
    countOfPoints?: number | null;
    countOfWins?: number | null;
  }>;
};
...
export function useLeaguesQuery(
  baseOptions?: Apollo.QueryHookOptions<LeaguesQuery, LeaguesQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<LeaguesQuery, LeaguesQueryVariables>(
    LeaguesDocument,
    options,
  );
}
export function useLeaguesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<LeaguesQuery, LeaguesQueryVariables>(
    LeaguesDocument,
    options,
  );
}
...
export type LeaguesQueryResult = Apollo.QueryResult<
  LeaguesQuery,
  LeaguesQueryVariables
>;
